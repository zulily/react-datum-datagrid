...
module.exports = class EditableIndicator extends React.Component
  
  render: ->
    <div className='rdd-editable-indicator' title="click to edit this cell, or double click anywhere in cell, or press enter with cell selected" onClick={@props.onClick}>
